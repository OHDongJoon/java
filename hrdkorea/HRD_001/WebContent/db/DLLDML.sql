...
SELECT SUM(PRICE) FROM MONEY_TBL_02 WHERE CUSTNO=100004;
/*회원매출 조회*/

/*최종*/
SELECT member.CUSTNO, member.CUSTNAME, member.GRADE, 
	(SELECT SUM(PRICE) from MONEY_TBL_02 WHERE CUSTNO=member.CUSTNO) SUM FROM MEMBER_TBL_02 member;
