...
<hr>
	...
	<ul class="mystyle"
        ...
        true; multiple:true; animation:true; duration:5000; active:true">
		<li><a class="uk-accordion-title" href="#">페이지 & 결과 값</a>
		...
		<li><a class="uk-accordion-title" href="#">메인페이지</a>
			<div class="uk-accordion-content">
				<h2 onclick="location='${conPath}/'">메인페이지로가기</h2>
			</div></li>
	</ul>
</body>
</html>