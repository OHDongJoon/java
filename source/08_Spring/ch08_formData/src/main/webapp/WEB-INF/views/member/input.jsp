...
<body>
	...
	<!--  join 과 달리 공통 경로가 없으니 My Controoler 로가라 -->
	<a href="${conPath }/studentId/aaa">studentId에 aaa로 전송</a> <!-- 요청경로가 : "studentId/모든거" 인거야  너 넙치된거야  -->
	<a href="${conPath }/studentId/bbb">studentId에 bbb로 전송</a> 
	<a href="${conPath }/studentId/파송송">studentId에 파송송로 전송</a>
</body>
</html>
