	 ...
	 <c:if test="${totCnt != 0 }">
	 	<c:forEach items="${boardList }" var="bDto">
	 	 <tr onclick="trclicked(${bDto.bid})">
	 	   	...
	 	   	<td>
	 	   	   <fmt:formatDate value="${bDto.bdate }" pattern="yy/MM/dd(E) hh:mm:ss(a)"/><!-- 타임스템프 -->
	 	   	   <%-- <fmt:formatDate value="${bDto.date }" pattern="yy/MM/dd(E) hh:mm:ss(a)"/><!-- 데이트 --> --%>
	 	   	</td>
	 	   	<td>
