...
// System.out.prinln(s1) => [사번] a01 [이름] 홍길동 [부서]compu [입사일]2022년 3월 24일 (목) (
public class Sawon {
	...
	public Sawon(String num, String name, String dept, int y, int m, int d) {
		...
		this.name = name;
		this.dept = dept;
		// 웬만하면 놉 hiredate = new Date(y-1900, m-1, d);// 입사일을 y년 m월d일로
		hiredate = new Date(new GregorianCalendar(y, m-1, d).getTimeInMillis());
	}
	@Override
	public String toString() {//System.out.prinln(s1) => [사번] a01 [이름] 홍길동 [부서]compu [입사일]2022년 3월 24일 (목)
