			...
			if(totalCnt == 0){ // 갯수가 0이면
				...
				for(BoardDto dto : dtos){
					...
					out.println("<td class='left'>"); //<img src='/ch13_board/img/hot.gif'>
						...
						if(dto.getRe_indent() > 0){  //indent >0 이면 답변글
							int width = (dto.getRe_indent()-1) * 10;  // INDENT(1,2,3,...) * 10
							// <img src='../img/level.gif' width=width height='10'> 들여쓰기 공간 확보 
							// <img src='../img/re.gif' width=width(위), height='10'>
							out.println("<img src='../img/level.gif' width='" + width + "' height='10'>");
							out.println("<img src='../img/re.gif'>");
						}
					if(dto.getReadcount() > 10){ // 인기글 처리
						// 답변글 들여쓰기 - re.gif출력 
						//조회수가 10을 넘으면 핫 그림 출력
