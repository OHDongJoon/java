...
<%
	int num=0;
	BoardDto dto = new BoardDto(); // num 이 널이면 원글 있으면 답변
	String pageNum = request.getParameter("pageNum");   // 원글쓰기는 안들어옴 
	if(pageNum==null){
		pageNum = "1";
	}
	if(request.getParameter("num") != null){ // num이 널이 아니면 애는 답변글이고 원글의 정보를 dto에 저장?
