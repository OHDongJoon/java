...
<body>
 ...
 <div id="content_form">
  ...
  System.out.println(fbDto + "글 수정 자~ 드가자 ~");
  %>
       ...
       <tr><th>글번호</th>
        ...
        <tr><th>글제목</th>
          <td><input type="text" name="fsubject" value="<%=fbDto.getFsubject() %>"
                          autofocus="autofocus"  readonly="readonly"></td>
        </tr>
        ...
        <tr><th>본문</th><td><textarea rows="5" cols="20"
                name="fcontent"><%=fbDto.getFcontent() %></textarea></td>
        </tr>
        <tr><th>삭제용비번</th>
            <td>
