...
<%MemberDto member = (MemberDto)session.getAttribute("member");
	if(member==null){ //세션에뭐가없는데 뭔 정보수정이야 로그인  페이지로 가 임마!!
...
%>
	<form action="modifyOk.jsp" method="post" name="modify_frm" onsubmit="return infoConfirm()">
		<table>
			...
			<tr>
				<th>새비밀번호</th>
				<td><input type="password" name="pw" placeholder="비밀번호 수정을 원하지 않으면 입력하지마!" ></td>
			</tr>
			<tr>
				<th>새비번확인</th>
			...
			<tr>
				...
				<td><select name="phone1">
				    ...
				    <input type="text" name="phone3" value='<%=phone3!=null? phone2:"" %>' size="2">
				 </td>
			</tr>
			<tr>
				<th>성별</th>
			...
			<tr>
				...
				<input type="reset" value="진영이취소">
				<input type="button" value="진영이아웃" onclick="location.href='logout.jsp'">
			</td>
		</table>
	</form>
</body>
