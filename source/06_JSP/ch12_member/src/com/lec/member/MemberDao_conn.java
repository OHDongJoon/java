...
public class MemberDao_conn {
	...
	private  Connection getConnection() throws SQLException{
		// 컨넥션풀의 DataSource안에 conn객체 이용  (Context  javax.naming)
		...
		return conn; // 야 컨에 쓰레기값이야 값 넣어 임마 
	}
	...
	public int loginCheck(String id, String pw) {
		...
		try {
			...
			if(rs.next()) { // 유효한 id를 입력
				String pwDB = rs.getNString("pw"); // 입력받은 값이 유효한 pw 
				if(pwDB.equals(pw)) {
