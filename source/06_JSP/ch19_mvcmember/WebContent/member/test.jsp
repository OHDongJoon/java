...
<%@page import="com.lec.memberdto.MemberDto"%>
...
<body>
   ...
   int result = dao.loginCheck("aaa", "111");
   ...
   MemberDto member = dao.getMember("bbb");
   out.println("<p>"+member+"</p>");
   out.println("<h3>3.회원id중복체크</h3>");
   if(MemberDao.EXISTENT == dao.confirmId("asd")){
      out.println("asd는 중복된 ID");
   }else if(MemberDao.NONEXISTENT == dao.confirmId("asd")){
      out.println("asd는 사용가능한 ID");
   }
