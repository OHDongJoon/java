...
SELECT * FROM EMP WHERE ENAME = 'FORD'; -- 서브쿼리
...
INSERT INTO EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) VALUES ('33','오동준','IT','55','22/09/01',900,0,20);
 ...
 UPDATE EMP 
    ...
    SET SAL = 1000
        ...
        SELECT * FROM EMP WHERE ENAME ='오동준';
...
SELECT * FROM EMP WHERE ENAME='오동준'; -- 인덱스 생성 후 : 0.001 ~ 0.002초 
